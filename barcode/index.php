...
include_once('html/include/function.php');
...
<html>
    <head>
        ...
        <script src="html/jquery-1.7.2.min.js"></script>
        <script src="html/barcode.js"></script>
    </head>
...
?>
            ...
            <div class="output">
                <section class="output">
                    <h2>Print This Student Barcode</h2><br>
                    <?php
                        $finalRequest = '';
                    ...
                    ?>
                    <div id="imageOutput">
                        <?php if ($imageKeys['text'] !== '') { ?><img src="html/image.php<?php echo $finalRequest; ?>" alt="Barcode Image" /><?php }
...
<!-- 
       ...
       -->
        ...
        <button id="no"  style="width:100px; height:40px; background:#0a0; color:white; border-radius:50px 50px; outline:none;" id="print_btn" onclick="print()">Print Barcode</button>
